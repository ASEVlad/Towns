...
def get_daily_points(towns_profile: TownsProfileManager):
    try:
        ...
        wait_until_element_is_visible(towns_profile, By.XPATH, '//input[@type="file"]')
        ...
        beaver_text_element = wait_until_element_is_visible(towns_profile, By.XPATH, "//*[contains(text(), 'Towns Points')]")
        ...
        wait_until_element_is_visible(towns_profile, By.XPATH, beaver_box_xpath)

        # find and click on beaver_belly element
        beaver_belly_element = wait_until_element_is_visible(towns_profile, By.XPATH, ".//canvas")
        ...
        if len(cooldown_elements) == 0:
            ...
            pay_with_ETH_element = wait_until_element_is_visible(towns_profile, By.XPATH, "//*[contains(text(), 'Pay with ETH')]")
